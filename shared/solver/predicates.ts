...
import { type Board, countTrait, hasTrait, unitMembers, unitsOfKind } from './board';
import { ARITH_EVALUATORS } from './arith';

// Re-exported because every caller of the solver reaches for the board through
// `predicates.ts`, and the split into `board.ts` is about module cycles rather
// than about the shape of the API.
export { type Board, MAX_ENUMERATED_UNIT, countTrait, hasTrait, makeBoard, unitMembers, unitsOfKind } from './board';
